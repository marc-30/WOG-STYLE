    ...
    megaMenuColumns: [
      {
        title: 'Collections',
        links: [
          { label: 'Toutes les collections', href: '/collection', highlighted: true },
          { label: 'GENÈSE', href: '/collection/genese' },
          { label: 'Homme', href: '/collection?genre=homme' },
          { label: 'Femme', href: '/collection?genre=femme' },
          { label: 'Unisexe', href: '/collection?genre=unisexe' },
        ],
      },
      {
        title: 'Catégories',
        links: [
          { label: 'Vêtements', href: '/collection?categorie=vetements' },
          { label: 'Accessoires', href: '/collection?categorie=accessoires' },
          { label: 'Éditions limitées', href: '/collection?categorie=editions-limitees' },
        ],
      },
    ],
    megaMenuImages: [
